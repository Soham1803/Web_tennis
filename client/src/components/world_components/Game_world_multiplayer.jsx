...
import Tennis_game_multi_player from "../models_components/Tennis_game_multi_player"


const Game_world_multiplayer = () => {
...
export default Game_world_multiplayer;
